function getLogin(username) {
    ...
    try {
        var logins = myLoginManager.findLogins({}, "chrome://flossfox", null, "Twitter Auth");
...
function setLogin(username, password) {
    ...
    var loginInfo = new nsLoginInfo("chrome://flossfox", null, "Twitter Auth", username, password, "", "");
...
function initPrefsDialog() {
    ...
    prefs = prefs.getBranch("extensions.flossfox.");
